...
export interface DashboardDoc { id?: string; name?: string; /** a look for the dashboard on finicast.com: default | banking (a pitch-book page) | revenue (SaaS revenue ops) | boardroom (dark) | print */ theme?: string; cards: DashboardCardDoc[] }
